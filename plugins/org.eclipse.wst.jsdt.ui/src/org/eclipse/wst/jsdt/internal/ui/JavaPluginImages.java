...
public class JavaPluginImages {
	...
	public static final String IMG_OBJS_CUNIT= NAME_PREFIX + "protelis.gif"; 				//$NON-NLS-1$
	public static final String IMG_OBJS_CUNIT_RESOURCE= NAME_PREFIX + "protelis.gif"; 				//$NON-NLS-1$
